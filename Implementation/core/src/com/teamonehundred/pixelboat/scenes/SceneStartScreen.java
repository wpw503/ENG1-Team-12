...
public class SceneStartScreen implements Scene {
  ...
  * 
  * <p>Initialises a Scene textures for StartScreen. Including start menu for playing 
  * the game and options. When options are hovered over they will change texture indicating 
  ...
  */
  public SceneStartScreen() {
    ...
    playHovered = new Texture("start_menu_playHovered.png");
    ...
    optionsHovered = new Texture("start_menu_optionsHovered.png");
  ...
  */
  ...
  /**
  * Update function for SceneStartScreen. Ends SceneStartScreen based on user input otherwise 
    stays in scene.
  * 
