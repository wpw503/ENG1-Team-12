...
public abstract class MovableObject extends GameObject {
   ...
   */
  MovableObject(int x, int y, int w, int h, String texturePath) {
   ...
   */
  MovableObject(int x, int y, int w, int h, String texturePath, int frameCount) {
   ...
   * @param frameCount int frame count
   */
  MovableObject(int x, int y, int w, int h, Texture t, int frameCount) {
  ...
  /**
  * Updates position of movable object based on speed and decreases speed according to 
    drag calculation.
  *
  * @author James Frost
  * @author William Walton
  ...
  *
  * <p>If maxSpeed (terminal velocity) is reached for the movable object then don't increase speed.
  *
  * @author James Frost
  * @author William Walton
  */
