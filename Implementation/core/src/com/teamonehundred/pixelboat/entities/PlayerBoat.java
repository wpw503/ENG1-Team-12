...
public class PlayerBoat extends Boat {
  ...
  * @param h                  int height of the new boat
  * @param texturePath       
    String relative path from the core/assets folder of the boats texture image
  ...
  * @author William Walton
  */
  PlayerBoat(int x, int y, int w, int h, String texturePath, String name, float durabilityPerHit, 
      float staminaUsage, float staminaRegen) {
  ...
  */
  ...
  public void initialise() {
    staminaTexture = new Texture("staminaTexture.png");
    durabilityTexture = new Texture("durabilityTexture.png");
   ...
   * 
   * <p>Updates the x and y position of the sprite with new x and y
    according to which input has been requested.
  ...
  */
  ...
  /**
   * Update the position and size of the UI elements (e.g. stamina bar and durability bar)
  ...
  private void updateUISprites() {
    staminaBar.setPosition(-uiBarWidth / 2 + sprite.getX() 
         + sprite.getWidth() / 2, -50 + sprite.getY());
    durabilityBar.setPosition(-uiBarWidth / 2 + sprite.getX() 
         + sprite.getWidth() / 2, -35 + sprite.getY());
