...
/**
 * Represents the Tutorial Scene for when the player wants
 * to see the controls and learn the purpose of UI elements
...
public class SceneTutorial implements Scene {
  ...
  /**
   * Update function for SceneTutorial. Ends SceneTutorial based on user input
   * otherwise stays in scene.
   *
   * <p>Returns an specified integer when you want to exit the screen
   * else return scene_id if you want to stay in scene.
   * In this case any key pressed on the keyboard will stop
   * the Tutorial Scene and continue with the main game.
   *
