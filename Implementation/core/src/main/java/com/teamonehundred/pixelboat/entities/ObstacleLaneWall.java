...
public class ObstacleLaneWall extends Obstacle {
   ...
   *
   * <p>Image is taken by default from C:\...\ENG1-Team-12\Implementation\core\assets.
   *
   * @author James Frost
  ...
  public ObstacleLaneWall(float x, float y, String texturePath) {
    super(x, y, 32, texture_height, texturePath, 2);
    setAnimationFrame(0);
  }
