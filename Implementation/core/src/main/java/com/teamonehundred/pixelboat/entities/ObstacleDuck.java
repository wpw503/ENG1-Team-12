...
public class ObstacleDuck extends Obstacle {
   ...
   *
   * <p>Duck image is taken by default from C:\...\ENG1-Team-12\Implementation\core\assets.
   ...
   *
   * <p>Creates a new collision bounds object representing the current position of this duck.
